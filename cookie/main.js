	...
	Game.Init=function()
	{
		...
		Game.getNewTicker=function(manual)//note : "manual" is true if the ticker was clicked, but may also be true on startup etc
		{
			...
			if (list.length==0)
			{
				...
				else if (Game.cookiesEarned<100000) list.push('Your cookies kill.');
				else if (Game.cookiesEarned<500000) list.push('No one loves you.');
				else if (Game.cookiesEarned<1000000) list.push('everyone wants to die');
				else if (Game.cookiesEarned<5000000) list.push('why are we doing this?');
		...
		*/
		...
		Game.dragonLevels=[
			...
			{name:'Krumblor, cookie hatchling',action:'Train Elder Battalion<br><small>Aura : grandmas gain +1% CpS for every non-grandma building</small>',pic:4,
				cost:function(){return Game.Objects['GOD SAVE US'].amount>=100;},
